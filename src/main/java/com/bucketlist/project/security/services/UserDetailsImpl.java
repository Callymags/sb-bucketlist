package com.bucketlist.project.security.services;
...
public class UserDetailsImpl implements UserDetails {
    ...
    // These methods must overwrite the methods in UserDetails interface.
    // Lombok handles other getters, but the below are required by Spring Security.
